...
<div class="col-md-6 col-sm-6 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2><a href="ic.php"><i class="fa fa-bars"></i> Inserir Alunos de Iniciação Científica </a></h2>
            <ul class="nav navbar-right panel_toolbox">
...
<div class="col-md-6 col-sm-6 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2><a href="ics_tab.php"><i class="fa fa-bars"></i> Listar Alunos de Iniciação Científica </a></h2>
            <ul class="nav navbar-right panel_toolbox">
                <li><a class="collapse-link"><i class="fa fachevron-up"></i></a>
                </li>
                <li class="dropdown">
