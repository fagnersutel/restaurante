                                    ...
                                    <div class="x_content">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                {
                                                    echo "<tr>";
                                                    echo "<td><b>" . $_SESSION['idfornecedor'][$i] . "</b></td>";
                                                    echo "<td><b>" . $_SESSION['fornecedor_desc'][$i] . "</b></td>";
                                                    echo "<td><b>" . $_SESSION['fornecedor_cnpj'][$i] . "</b></td>";
                                                    echo "<td><b>" . $_SESSION['idCidade'][$i] . "</b></td>";
                                                    echo "<td><b>" . $_SESSION['CidadeDesc'][$i] . "</b></td>";
                                                    echo "<td><b>" . $_SESSION['EstadoDesc'][$i] . "</b></td>";
                                                    echo "</tr>";
                                                }
                                                ?>
