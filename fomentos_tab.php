...
include_once '../Classes/FomentoProf.class.php';
$ics = new FomentoProf($db, $idfomentos, $fomentos_valor, $fomentos_ics, $fomentos_inicio, $fomentos_termino, $fomentador, $autor, $moeda);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3>Fomentos <small>por Agência</small></h3>
                            </div>                           
                        </div>
