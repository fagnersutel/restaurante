                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="index.php" class="site_title"><i class="fa fa-search"></i> <span>Gestão</span></a>
                        </div>
                    ...
                    <div class="">
                        ...
                        <div class="">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2><i class="fa fa-bars"></i> Orientações <small>...</small></h2>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2><i class="fa fa-bars"></i> Normas <small>....</small></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                            </li>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                            <ul id="myTab1" class="nav nav-tabs bar_tabs right" role="tablist">
                                                <li role="presentation" class="active"><a href="#tab_content11" id="home-tabb" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">#</a>
                                                </li>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2><a href="inic.php"><i class="fa fa-bars"></i> Pedidos</a></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2><a href="fomen.php"><i class="fa fa-bars"></i> Estoque</a></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="collapse-link"><i class="fa fachevron-up"></i></a>
                                            </li>
                                            <li class="dropdown">
