                                    ...
                                    <div class="x_content">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                {
                                                    echo "<tr>";
                                                    echo "<td><b>" . $_SESSION['idproduto'][$i] . "</b></td>";
                                                    echo "<td><b>" . $_SESSION['produto_desc'][$i] . "</b></td>";
                                                    echo "<td><b>" . $_SESSION['unidade_de_medida_idunidade_de_medida'][$i] . "</b></td>";
                                                    echo "<td><b>" . $_SESSION['unidade_de_medida_desc'][$i] . "</b></td>";
                                                    echo "<td><b>" . $_SESSION['unidade_de_medida_cod'][$i] . "</b></td>";
                                                    echo "</tr>";
                                                }
                                                ?>
