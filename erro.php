      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
              ...
              <h1>Você deve inserir sua nova senha e confirmar a senha de igual teor</h1>
              <div class="clearfix"></div>

              <div class="separator">
                <p class="change_link">
                    <a href="alteracao.php" class="to_register"> Retornar para alteração de senha </a>
                </p>
                <p class="change_link">
                    <a href="index.php" class="to_register"> Retornar para o Painel </a>
                </p>
