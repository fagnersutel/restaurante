	...
	action: function ( e, dt, button, config ) {
		...
		if ( document.queryCommandSupported('copy') ) {
			...
			try {
				...
				dt.buttons.info(
					dt.i18n( 'buttons.copyTitle', 'Copiar' ),
		...
		dt.buttons.info( dt.i18n( 'buttons.copyTitle', 'Copiar' ), message, 0 );
...
DataTable.ext.buttons.csvHtml5 = {
	...
	text: function ( dt ) {
		return dt.i18n( 'buttons.csv', 'CSVs' );
	},
...
DataTable.ext.buttons.excelHtml5 = {
	...
	text: function ( dt ) {
		return dt.i18n( 'buttons.excel', 'Excelas' );
	},
