...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                $('#sinal_autocomplete2').simpleAutoComplete('../Classes/ajax_query_artigos.php', {
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Registro de melhores artigos <small>Informe até DOIS artigos mais citados com alunos do PPG</small></h2>
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form id="demo-form2" action="melhorartigo.php" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Autor / Orientador <span class="required">*</span>
                                                </label>
                                            ...
                                            <div class="form-group">
                                                <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">ARTIGO</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">ANO</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
