    ...
    <head>
        ...
        <script language="javascript" type="text/javascript" src="./js/document.js"></script> 	
         <script type="text/javascript">
            ...
            {
                $('#sinal_autocomplete2').simpleAutoComplete('./Classes/ajax_query_cidade.php', {
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Informe  <small>Dados da Razão Social</small></h2>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content">
                                        <br />
                                        <form id="demo-form2" action="fornecedores.php" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">CNPJ<span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="first-name"  name='cpfcnpj' required="required" class="form-control col-md-7 col-xs-12 cpfOuCnpj" value="<?php echo $_SESSION['txt2']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Cidade*</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
