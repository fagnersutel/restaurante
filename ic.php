                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Alunos de Iniciação Científica <small>Informe nome, data de início, bolsa e projeto do PPG relacionado</small></h2>
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form id="demo-form2" action="ics.php" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Bolsa</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select class="form-control" name="bolsa" required="required"  >
                                                        <option>Selecione</option>
                                                        <?php
                                                        require_once 'inc/select_bolsas.php';
                                                        ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Projeto de Pessquisa</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">LInha de Pesquisa</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
